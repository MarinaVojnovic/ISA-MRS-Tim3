				...
				success : function(data) {
					...
					for ( var counter in response) {
						...
						cell12.innerHTML = new Date(
								response[counter].fastResStartDate);
						cell13.innerHTML = new Date(
								response[counter].fastResEndDate);
				...
				.ajax({
					...
					success : function(data) {
						...
						if (broj != 0) {
							...
							$("#rentacarReservation")
									.append(
											'<br><br><button type="submit" style="background: #ff1a75;  align: center; color: white" id="offerHotelsButton" style="float: left;/">Reserve hotel</button>');
							$("#rentacarReservation")
									.append(
											'<br><button type="submit" style="background: #ff1a75;  align: center; color: white" id="offerHotelsButton" style="float: left;/">Finish reservation </button>');
						} else {
							$(".messageSuitableCars")
									.append(
											'<h3>No cars found to satisfy your criteria.</p>');
...
$(document)
		.on(
				...
				function(e) {
					...
					$("#flightReservation")
							.append(
									'<button type="submit" style="background: #ff1a75; color: white" id="offerHotelsButton" style="float: left;/">Hotels</button>');
