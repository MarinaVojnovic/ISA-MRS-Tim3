...
public class ReportHotelAttendanceDTO {
	...
	public ReportHotelAttendanceDTO(ArrayList<String> dailyLabels, ArrayList<Integer> dailyValues,
	...
	public ReportHotelAttendanceDTO() {
		super();
	}
