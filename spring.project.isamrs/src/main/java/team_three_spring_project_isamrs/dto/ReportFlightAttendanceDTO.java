...
public class ReportFlightAttendanceDTO {
	...
	public ReportFlightAttendanceDTO() {
		super();
	}
	public ReportFlightAttendanceDTO(ArrayList<String> dailyLabels, ArrayList<Integer> dailyValues,
